...
public class AnalogPinDragInspector : Editor
{
	public override void OnInspectorGUI()
	{
		...
		analogPinDrag.dragForceTolerance = EditorGUILayout.FloatField("Force Tolerance", analogPinDrag.dragForceTolerance);
		...
		EditorGUILayout.LabelField("DragForce", analogPinDrag.DragForce.ToString("F3"));
